        ...
        getProduct() {
            this.axios.get(`http://localhost:8876/api/products/${this.$route.params.id}`)
                ...
                .finally(() => {
                    ...
                    $(".single-product-one-nav").slick('refresh');
                    $(".single-product-one").slick('refresh');
                })
        },
                    ...
                    <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
                        <div class="single-product-box one">
                            <div class="big-product single-product-one slider-for">
                                <div v-for="img in product.product_images">
                                    <div class="single-item"> <img :src="img.url" alt="">
                            ...
                            <div class="navholder">
                                <div class="product-slicknav single-product-one-nav slider-nav">
                                    <div v-for="img in product.product_images"> <span class="single-item"> <img
                        ...
                        <div class="shop-details-top-right ">
                            <div class="shop-details-top-right-content-box">
                                ...
                                <div class="shop-details-top-color-sky-box">
                                    <h4>Color:</h4>
                                    <ul class="varients">
                                        <template v-for="product in product.group_products">
                                        <li v-for="color in product.colors"> <a href="#0" :style="`background: #${color.title}; width: 50px; height: 50px;`"
                                                                                class="shop-details-top-color-sky-img"
                                                data-src="@/assets/images/shop/products-img1.jpg">  </a> </li>
                                        </template>
                                    </ul>
                                </div>
                                ...
                                <ul class="shop-details-top-category-tags">
                                    <li v-if="product.category">Category: <span>{{ product.category.title }}</span></li>
                                    <li v-if="product.tags">Tags: <span>{{ product.tags.map((tag) => tag.title).join(', ') }}</span></li>
                                </ul>
