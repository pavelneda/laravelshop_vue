...
export default {
    ...
    mounted() {
        ...
        let vueThis = this;
        document.querySelectorAll('#sortSelect li').forEach(function (elem) {
            elem.addEventListener("click", function () {
                vueThis.sortProducts = elem.dataset.value
                vueThis.getProducts()
            });
        });
    },
    ...
    methods: {
        ...
        changeSort() {
            ...
            console.log(document.querySelector('#sortSelect .nice-select .current').innerHTML);
        },
        ...
        addColor(id) {
            if (!this.colors.includes(id)) {
                ...
                this.colors = this.colors.filter((n) => {
                    return n != id
                })
            }
        },
                ...
                .then(res => {
                    ...
                    if ($("#price-range").length) {
                        $("#price-range").slider({
                            ...
                            max: +this.filterList.price.max + 1,
                            ...
                            <div class="sidebar-holder">
                                    ...
                                    <div class="checkbox-item">
                                        <form>
                                            <div v-for="category in filterList.categories" class="form-group"><input
                                                    v-model="categories" :value="category.id" type="checkbox"
                                ...
                                <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                                    ...
                                    <ul class="color-option">
                                        <li @click.prevent="addColor(color.id)" v-for="color in filterList.colors"><a
                                                href="#0" class="color-option-single"
                                ...
                                <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                                    ...
                                    <div class="slider-box">
                                        ...
                                        <button @click.prevent="getProducts()" class="filterbtn"
                                                type="submit"> Filter
                                        </button>
                                    </div>
                                </div>
                                <div class="single-sidebar-box mt-30 wow fadeInUp animated pb-0 border-bottom-0 ">
                                    ...
                                    <ul class="popular-tag">
                                        <li @click.prevent="addTag(tag.id)" v-for="tag in filterList.tags"><a href="#0">{{
                                                tag.title
                                            }}</a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-xl-12">
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="short-by">
                                            <div class="select-box" id="sortSelect">
                                                <select class="wide">
                                                                    ...
                                                                    <div class="quick-view__left-content"
                                                                        ...
                                                                        <div class="tabs">
                                                                            <div class="popup-product-thumb-box">
                                                                                <ul>
                                                                                    <li v-for="product_image in popupProduct.product_images"
                                                                            ...
                                                                            <div class="popup-product-main-image-box">
                                                                                <div v-for="product_image in popupProduct.product_images"
                                                                                     :id="`tabb${product_image.id}`"
                            ...
                            <div class="col-12 d-flex justify-content-center wow fadeInUp animated">
                                <ul class="pagination text-center">
                                    <li class="next" v-if="pagination.current_page != 1">
                                        <a href="#0"
                                           @click.prevent="getProducts(Number(pagination.current_page) - 1)">
                                            <i class="flaticon-left-arrow-1" aria-hidden="true"></i>
                                        </a>
                                    </li>
                                    <li v-for="link in pagination.links">
                                        <template v-if="Number(link.label)">
                                            <template v-if="pagination.current_page - link.label > -2 && pagination.current_page - link.label < 2
                                                || link.label == 1 || link.label == pagination.last_page">
                                                <a href="#0" :class="link.active ? 'active' : ''"
                                                   @click.prevent="getProducts(link.label)">{{ link.label }}</a>
                                            </template>
                                            <template v-if="(pagination.current_page - link.label == -2 || pagination.current_page - link.label == 2)
                                                         && link.label > 1 && link.label < pagination.last_page">
                                                <a>...</a>
